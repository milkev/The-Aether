...
public class FallingOrangePetalParticle extends TextureSheetParticle {

    private static final SplittableRandom random = new SplittableRandom();
    private final float rotateFactor;
    private final double velocityComposite, velocityDown;

    protected FallingOrangePetalParticle(ClientLevel clientWorld, double d, double e, double f, double g, double h, double i, SpriteSet provider) {
        ...
        this.quadSize = (float) (0.0375 + (random.nextDouble() / 16));
    }
