...
public enum AetherArmorType {
    ...
    Obsidian(new AetherArmorMaterial("obsidian", 38, new int[]{4, 8, 10, 4}, 6, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, Blocks.AIR, 0.1F), 0x1B1447),
    Valkyrie(new AetherArmorMaterial("valkyrie", 35, new int[]{4, 8, 10, 4}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 1.5F, Blocks.AIR, 0.1F), 0xDDDDDD),
